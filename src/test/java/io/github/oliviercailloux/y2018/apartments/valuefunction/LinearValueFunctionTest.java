...
class LinearValueFunctionTest {
	...
	void getSubjectiveValueTest() {
		...
		Assertions.assertEquals(0.25, f.getSubjectiveValue(20.0), 0);
	}

	@Test
	void applyTest() {
		LinearValueFunction f = new LinearValueFunction(10,50);
		Assertions.assertEquals(0.25, f.apply(20.0), 0);
	}

	@Test
	void getSubjectiveValueLowerTest() {
		LinearValueFunction f = new LinearValueFunction(10,50);
		Assertions.assertEquals(1, f.getSubjectiveValue(100.0), 0);
	}
	...
	void getSubjectiveValueUpperTest() {
		LinearValueFunction f = new LinearValueFunction(10,50);
		Assertions.assertEquals(0, f.getSubjectiveValue(9.0), 0);
	}
