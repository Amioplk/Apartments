...
class ReversedLinearValueFunctionTest {
	...
	void getSubjectiveValueTest() {
		...
		Assertions.assertEquals(0.25, f.getSubjectiveValue(40.0), 0);
	}
	...
	void getSubjectiveValueLowerTest() {
		ReversedLinearValueFunction f = new ReversedLinearValueFunction(10,50);
		Assertions.assertEquals(1, f.getSubjectiveValue(5.0), 0);
	}
	...
	void getSubjectiveValueUpperTest() {
		ReversedLinearValueFunction f = new ReversedLinearValueFunction(10,50);
		Assertions.assertEquals(0, f.getSubjectiveValue(55.0), 0);
	}

	@Test
	void applyTest() {
		ReversedLinearValueFunction f = new ReversedLinearValueFunction(10,50);
		Assertions.assertEquals(0.25, f.apply(40.0), 0);
	}
