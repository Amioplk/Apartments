...
public class ModifyApartmentGUI extends FormApartmentGUI {
	...
	/**
	 * This method initializes every element of the form with the data present in
	 * the Apartment apart field. It used getApartment() in order to get the
	 * apartment from the xml file transmit in the main method
	 * 
	 * @throws IOException
	 */
